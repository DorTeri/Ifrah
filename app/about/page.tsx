                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 text-right">
                            ...
                            <p className="mb-6 text-base leading-7 text-gray-500 dark:text-gray-400">
                                ...
                                וחרטה על דגלה להוביל את השוק הישראלי בתחום ייצור פיתוח מרכבים. חברת יפרח ייצור מרכבים גאה לספק לך את הפתרון המקיף ביותר לייצור, התאמה ותחזוקה שוטפת של מרכבים למשאיות. אנו מתמחים בייצור כל סוגי המרכבים עם וותק של למעלה מ30 שנה, לכל מטרה ובהתאם לדרישות הלקוח, והכל באמצעות ציוד טכנולוגי מתקדם, רמת תכנון הנדסי גבוה ומערכת בקרת איכות יעילהץ. אנו בחברת ייפרח ייצור מרכבים עושים הכל כדי שלא תשים לב אלינו
                            </p>
                        </div>
                    </div>
                </div>
